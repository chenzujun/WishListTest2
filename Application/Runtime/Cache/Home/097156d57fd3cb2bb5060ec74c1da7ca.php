	...
	<section class="body">
		...
		<div>
			<div class="girlImg">
				...
				<img class="answerClass" id="answerCanvas" width="287" height="152"
				...
				<script>
					...
					gray.fillRect(3, 148, 294, 188);

					gray.font = "24px 黑体";
					gray.fillStyle = "#f42dab";
					gray.fillText(msg1, 30, 230);
					gray.fillText(msg2, 50, 270);
					...
					myCanvas.addEventListener(
									...
									function(e) {
										...
										e.preventDefault();
										var offsetX = myCanvas.offsetLeft + 3, offsetY = myCanvas.offsetTop + 148;
					...
					myCanvas.addEventListener('touchend', function(e) {
						e.preventDefault();
						var num = 0;
						var datas = gray.getImageData(3, 148, 294, 188);
